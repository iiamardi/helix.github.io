...
<head>
    ...
    <title>Add Product - Farmacia Jonë</title>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    ...
                                    <option value="Barnat e Përshkruara">Barnat e Përshkruara</option>
                                    <option value="Barnat pa Recetë">Barnat pa Recetë</option>
                                    <option value="Produkte Natyrale">Produkte Natyrale</option>
                                </select>
                            </div>
